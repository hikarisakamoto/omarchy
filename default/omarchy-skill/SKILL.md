...
description: >
  ...
  ~/.config/alacritty/, ~/.config/kitty/, ~/.config/ghostty/, ~/.config/wezterm/, ~/.config/mako/,
...
- Editing terminal configs (alacritty, kitty, ghostty, wezterm)
...
| **Alacritty/Kitty/Ghostty/WezTerm** | Terminals | `~/.config/<terminal>/` |
